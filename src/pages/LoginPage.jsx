        ...
        <div className="login-left-panel">
          <div className="brand-content">
            <div className="brand-logo-large">
              <img src="/QuantoLogo.png" alt="Logo" className="logo-img" />
            </div>
            <h1 className="brand-title">Bienvenue sur <span className="brand-highlight">Prev-IX</span></h1>
            <p className="brand-description">
              Votre plateforme intelligente pour la gestion d'actifs et l'analyse prédictive
            </p>
